...
> :warning: Note that the flag `-win=true` must be specified as shown in the above commands. This flag is very important becase the same allow to indicate that the tests will be executed on the Windows environment.
